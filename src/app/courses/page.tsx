...
const coursesData: Course[] = [
  {
    ...
    shortDesc: "Foundation course for self-healing, chakras, and Reiki principles.",
  ...
  },
  {
    ...
    shortDesc: "Symbols, distance healing, emotional and mental healing techniques.",
  ...
  },
  {
    ...
    title: "Karuna Reiki",
    slug: "karuna-reiki",
    shortDesc: "Compassion-based healing for deep emotional and karmic wounds.",
  ...
  },
  {
    ...
    title: "Money Reiki",
    slug: "money-reiki",
    shortDesc: "Healing money blocks, abundance mindset, and prosperity energy.",
...
export default function CoursesPage() {
  return (
    <section className="min-h-screen bg-lotus-bg px-4 py-16">
      <div className="mx-auto max-w-7xl">
        {/* Header */}
        <div className="mb-12 text-center">
          <h1 className="text-3xl sm:text-4xl font-semibold text-lotus-purple">
            Spiritual Healing Courses
          </h1>
          <p className="mt-3 text-lotus-muted max-w-2xl mx-auto">
