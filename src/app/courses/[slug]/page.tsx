  ...
  return (
    <section className="min-h-screen bg-lotus-bg px-4 py-12">
      <div className="mx-auto max-w-5xl">
        {/* Breadcrumbs */}
        <nav className="mb-6 text-sm text-lotus-muted">
          <Link href="/" className="hover:text-lotus-purple">Home</Link>
          <span className="mx-2">/</span>
          <Link href="/courses" className="hover:text-lotus-purple">Courses</Link>
          <span className="mx-2">/</span>
          <span className="text-lotus-text">{course.title}</span>
        </nav>

        {/* Hero */}
        <div className="relative rounded-3xl bg-lotus-section shadow-lg overflow-hidden group">
          {/* Glow */}
          ...
          <div className="relative grid grid-cols-1 md:grid-cols-2 gap-8 p-8">
            ...
            <div className="flex flex-col justify-center">
              ...
              <p className="mt-4 text-lotus-text">
                {course.description}
              </p>
        ...
        {/* Syllabus */}
        <div className="mt-14">
          <h2 className="text-2xl font-semibold text-lotus-purple mb-6">
            What You Will Learn
          </h2>
