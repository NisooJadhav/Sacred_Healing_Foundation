...
/* ------------------------------------------------------------------ */
/* Mock Cart Hook (replace with real one later) */
/* ------------------------------------------------------------------ */
...
const storeCategories: StoreCategory[] = [
...

  {
    ...
    images: [
      "/products/pyramid-1.jpeg",
      "/products/pyramid-2.jpeg",
    ],
  },

  {
    ...
    images: [
      "/products/crystal-wish-grid-box.jpeg",
    ],
  },
...

  {
    ...
    images: [
      "/products/reiki-charged-bottle.jpeg",
    ],
  },

  {
    ...
    images: [
      "/products/reiki-wellness-oil.jpeg",
    ],
  },
];
...
export default function StoreCategoryClient({ slug }: Props) {
  ...
  return (
    <section className="min-h-screen bg-gradient-to-b from-purple-50 to-white px-4 py-8 md:py-12">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid lg:grid-cols-2 gap-10">
          ...
          <div className="bg-white rounded-2xl shadow-xl p-6 md:p-8">
            ...
            <div className="mb-6 text-xl font-semibold text-purple-700">
