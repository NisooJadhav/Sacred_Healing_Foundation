...
export default function HomeAbout() {
  return (
    <section className="w-full bg-lotus-bg pt-16 pb-5 px-6 md:px-12">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-6 items-center">
        
        {/* LEFT CONTENT */}
        <div className="space-y-6">
          <h2 className="text-center text-3xl md:text-4xl font-serif text-lotus-purple leading-tight">
        ...
        <div className="relative flex justify-center md:justify-center">
          <div className="relative w-[280px] h-[360px] sm:w-[320px] sm:h-[420px] md:w-[360px] md:h-[480px] 
