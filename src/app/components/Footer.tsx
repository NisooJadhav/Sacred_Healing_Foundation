...
export default function Footer() {
  ...
  return (
    <>
      <footer className="bottom-0 w-full bg-lotus-purple text-white">
              ...
              <div className="space-y-3">
                ...
                <div className="flex items-center gap-3 text-purple-200">
                  ...
                  <a
                    ...
                    className="hover:text-white transition-colors"
                  >
                  <span className="text-sm">sacredhealingfoundation2712@gmail.com</span>
                  </a>
                </div>
              </div>
          ...
          <div className="mt-6 pt-6 border-t border-white-700 pb-4">
            <div className="flex flex-col md:flex-row justify-between items-center gap-4">
              <p className="text-purple-300 text-sm">
                © {new Date().getFullYear()} Sacred Healing Foundation. All
                rights reserved.
              </p>
